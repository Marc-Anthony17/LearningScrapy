...
class ScrapeOpsFakeUserAgentMiddleware:
    ...
    def _get_user_agents_list(self):
        ...
        if self.scrapeops_num_results is not None:
            payload['num_result'] = self.scrapeops_num_results
...
class ScrapeOpsFakeBrowserHeaderAgentMiddleware:
    ...
    def __init__(self, settings):
        ...
        self.scrapeops_fake_browser_heads_active = settings.get('SCRAPEOPS_FAKE_BROWSER_HEADER_ENABLED',False)
        self.scrapeops_num_results = settings.get('SCRAPEOPS_NUM_RESULTS')
        self.headers_list =[]
    ...
    def process_request(self, request, spider):
        ...
        # print("************************* New Header ********************************")
        # print(f"{request.headers['User-Agent']} { request.headers['accept-language']} { request.headers['upgrade-insecure-requests'] }")
